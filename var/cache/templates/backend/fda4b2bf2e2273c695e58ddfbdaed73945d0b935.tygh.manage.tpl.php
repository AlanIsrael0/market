<?php /* Smarty version Smarty-3.1.21, created on 2015-08-25 17:37:42
         compiled from "/var/www/html/market/design/backend/templates/views/languages/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:91423914455dc7db6df2e29-20553320%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fda4b2bf2e2273c695e58ddfbdaed73945d0b935' => 
    array (
      0 => '/var/www/html/market/design/backend/templates/views/languages/manage.tpl',
      1 => 1435242660,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '91423914455dc7db6df2e29-20553320',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55dc7db6e88741_58864898',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55dc7db6e88741_58864898')) {function content_55dc7db6e88741_58864898($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/market/app/functions/smarty_plugins/block.hook.php';
                            ...
                            <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
                                <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"languages:list_extra_links")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"languages:list_extra_links"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                                    ...
                                    <?php if ($_smarty_tpl->tpl_vars['language']->value['lang_code']!=@constant('DEFAULT_LANGUAGE')) {?>
                                        <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'class'=>"cm-confirm cm-post",'text'=>__("delete"),'href'=>"languages.delete_language?lang_id=".((string)$_smarty_tpl->tpl_vars['language']->value['lang_id'])));?>
</li>
                                    <?php }?>

                                    <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'class'=>"cm-language-name cm-post",'text'=>__("clone"),'href'=>"languages.clone_language?lang_id=".((string)$_smarty_tpl->tpl_vars['language']->value['lang_id'])));?>
</li>
                                    <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'class'=>"cm-post",'text'=>__("export"),'href'=>"languages.export_language?lang_id=".((string)$_smarty_tpl->tpl_vars['language']->value['lang_id'])));?>
</li>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("buttons", null, null); ob_start(); ?>
    <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
        <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"languages:manage_tools_list")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"languages:manage_tools_list"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
            ...
            <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'class'=>"cm-post",'text'=>__("on_site_live_editing"),'href'=>fn_url("customization.update_mode?type=live_editor&status=enable"),'target'=>"_blank"));?>
</li>
            <li class="divider"></li>
