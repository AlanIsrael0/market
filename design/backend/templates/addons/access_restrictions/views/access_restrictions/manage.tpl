...
{if $rules}
    ...
    {capture name="tools_list"}
        <li><a alan='1' data-ca-dispatch="dispatch[access_restrictions.make_permanent]" class="cm-process-items cm-submit cm-confirm" data-ca-target-form="access_restrictions_form">{__("make_permanent")}</a></li>
    {/capture}
